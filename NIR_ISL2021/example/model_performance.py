...
def get_args():
    ...
    parser.add_argument('--dataset', default='CASIA-Iris-Africa', type=str, dest='dataset_name')
    parser.add_argument('--ckpath', default=r'E:\zhangtong\eye_tell_all\NIR_ISL2021\example\M1-checkpoints', type=str, dest='checkpoints_path')
...
if __name__ == '__main__':
    ...
    check_mkdir(r'E:\zhangtong\eye_tell_all\NIR_ISL2021\test-result_m1')
    save_dir = os.path.join(r'E:\zhangtong\eye_tell_all\NIR_ISL2021\test-result_m1', test_args['dataset_name'])
