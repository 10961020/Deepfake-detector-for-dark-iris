...
import sys
sys.path.append('.../NIR_ISL2021/') # change as you need
...
def get_args():
    ...
    parser.add_argument('--ckpath', default=r'E:\zhangtong\eye_tell_all\NIR_ISL2021\example\afc-checkpoints', type=str, dest='checkpoints_path')
